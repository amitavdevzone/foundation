...
@section('title', 'My activities on the system')



@section('breadcrumb')
  <section class="content-header">
    <h1>My activities<small>Entry of your activities are recorded here.</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-sm-12">
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          @if($options != null)
            <form action="{{route('user-activities')}}" method="get" class="">
              <div class="row gap-bottom gap-20">
                ...
                <div class="col-sm-3">
                  ...
                  <a href="{{route('user-activities')}}" class="btn btn-primary">Reset</a>
                </div>
              </div>
            </form>
          @endif
